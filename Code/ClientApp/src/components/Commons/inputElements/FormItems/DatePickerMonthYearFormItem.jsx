...
export function DatePickerMonthYearFormItem(props) {
    const {
        label,
        name,
        hint,
...
DatePickerMonthYearFormItem.defaultProps = {
    required: false,
};

DatePickerMonthYearFormItem.propTypes = {
...
export default DatePickerMonthYearFormItem;