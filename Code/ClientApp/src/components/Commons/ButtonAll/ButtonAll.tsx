...
import { ArrowBack, Save, SaveAlt } from '@material-ui/icons';
...
export function ButtonEditTB(props) {
    const classes = LabelStyle();
    return (
        <IconButton color="primary" className={classes.bticonEdit} aria-label="Edit" {...props}>
...
export function ButtonDelete(props) {
    const classes = LabelStyle();
    return (
        <IconButton size="medium" color="secondary" className={classes.bticonDel} aria-label="Delete" {...props}>
            <DeleteForeverIcon />
        </IconButton>
    )
}
